...
def getAboutText():
    ...
    AboutText += _('Skin:\tiDreamy Mod ItalySat') + '\n'
...
class About(Screen):
    ...
    def populate(self):
        self['lab1'] = StaticText(_('ItalySat Image'))
        self['lab2'] = StaticText(_('By ItalySat Team Mod Redouane...'))
        model = None
        self['lab3'] = StaticText(_('Support at') + ' www.italysat.eu')
...
class AboutSummary(Screen):
    ...
    def __init__(self, session, parent):
        ...
        self['selected'] = StaticText('ItalySat:' + getImageVersion())
